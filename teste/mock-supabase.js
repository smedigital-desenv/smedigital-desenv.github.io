...
(function () {
  ...
  var DB = {
    perfis: [
      ...
      { id: 2, email: 'diretora.amaral@educacao.pmrp.sp.gov.br', nome: 'Ana Amaral (Diretora)', tipo: 'escola',     is_super_admin: false, ativo: true },
      { id: 3, email: 'coord.silva@educacao.pmrp.sp.gov.br',   nome: 'Carlos Silva (Coord.)', tipo: 'escola',     is_super_admin: false, ativo: true },
      { id: 4, email: 'contato@construtorabeta.com.br',        nome: 'Construtora Beta',      tipo: 'externo',    is_super_admin: false, ativo: true },
      { id: 5, email: 'secretaria.gestao@educacao.pmrp.sp.gov.br', nome: 'Setor de Gestão',   tipo: 'secretaria', is_super_admin: false, ativo: false }
    ],
    escolas: [
      { id: 1, codigo_inep: '35000111', nome: 'EMEF Prof. João Ribeiro',   email_institucional: 'joaoribeiro@educacao.pmrp.sp.gov.br', ativo: true },
      { id: 2, codigo_inep: '35000222', nome: 'EMEI Vila das Flores',      email_institucional: 'vilaflores@educacao.pmrp.sp.gov.br',  ativo: true },
